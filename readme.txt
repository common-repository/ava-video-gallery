...
Donate link: http://www.wpvideoplugins.com/ava-video-gallery/
Tags: ads, Longtail, analytics, google, playlist, rtmp, MP4, media, swf, plugin, wordpress, player, mp3, flv, video, flash, shadowbox, simple, advertisements, JW, editor, wysiwyg, vsocial, gamevideos, Post, veoh, garage tv, garage, vimeo, dailymotion, guba, aniboom, brightcove, myspace, ifilm, metacafe, yahoo, revver, clipfish, myvideo, google, sevenload, youtube, portal, embed, video, embedding
...
With this plugin you can create video galleries from flv videos or youtube videos. You can use the plugin as a widget. To display the plugin in your Posts type [ava_video ID /], where ID is the ava gallery ID.

For create and configure the video galleries press in your Wordpress admin: ava Video

Download and manual visit: http://www.wpvideoplugins.com/ava-video-gallery/


More Wordpress Video Plugins: http://www.wpvideoplugins.com/
...
1. Upload `ava-video` folder to the `/wp-content/plugins/` directory.
...
= What parameters should I set up to look good to me the ava? =
